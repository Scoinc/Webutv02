...
app.get('/keeb1', (req, res) => {
  //rendera sidan keeb1.ejs när klickad på i header
  res.render('pages/keeb1.ejs')
})

app.get('/keeb2', (req, res) => {
  //rendera sidan keeb2.ejs när klickad på i header
...
app.get('/mouse1', (req, res) => {
  //rendera sidan mouse1.ejs när klickad på i header
  res.render('pages/mouse1.ejs')
})

app.get('/mouse2', (req, res) => {
  //rendera sidan mouse2.ejs när klickad på i header
